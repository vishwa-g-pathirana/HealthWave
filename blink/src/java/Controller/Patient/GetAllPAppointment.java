 ...
 * @author Pubz
 */
@WebServlet(name = "GetAllPAppointment", urlPatterns = {"/GetAllPAppointment"})
public class GetAllPAppointment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while(rs.next()){
                ...
                out.println("<td><form method='get' action='/blink/profiles/patientprofile/edit-appointment.html'>"
                        + "<input type='hidden' value="+id+" name='id'>"
                        + "<input type='submit' value='update'></form></td>");
                
                out.println("<td><form method='get' action='PAppointmentDELETE'>"
                        + "<input type='hidden' value="+id+" name='id'>"
